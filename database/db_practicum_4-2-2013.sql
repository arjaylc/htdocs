...
--
-- Tables for Practicum Evaluation Form
--

CREATE TABLE IF NOT EXISTS `eval_course_content` (
...
CREATE TABLE IF NOT EXISTS `eval_impact` (
	`submitter` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eval_subject_application` (
	`submitter` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eval_skill` (
	`submitter` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eval_essay` (
	`submitter` varchar(40) NOT NULL,
...
--
-- Constraints for Practicum Evaluation Form Tables
--
  
ALTER TABLE `eval_course_content`
	ADD CONSTRAINT `fk_content_submitter` FOREIGN KEY (`submitter`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
	
ALTER TABLE `eval_impact`
	ADD CONSTRAINT `fk_impact_submitter` FOREIGN KEY (`submitter`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
	
ALTER TABLE `eval_subject_application`
	ADD CONSTRAINT `fk_subject_submitter` FOREIGN KEY (`submitter`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
	
ALTER TABLE `eval_skill`
	ADD CONSTRAINT `fk_skill_submitter` FOREIGN KEY (`submitter`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
	
ALTER TABLE `eval_essay`
	ADD CONSTRAINT `fk_essay_submitter` FOREIGN KEY (`submitter`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
